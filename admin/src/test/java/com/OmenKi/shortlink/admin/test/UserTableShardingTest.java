...
public class UserTableShardingTest {
    ...
    public static final String SQL = "CREATE TABLE `t_user_%d` (\n" +
            ...
            "  `username` varchar(25) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用户名',\n" +
            ...
            "  PRIMARY KEY (`id`)\n" +
            ") ENGINE=InnoDB AUTO_INCREMENT=1864278279805071363 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;";
