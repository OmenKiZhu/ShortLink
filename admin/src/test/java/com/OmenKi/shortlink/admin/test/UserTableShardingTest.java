...
public class UserTableShardingTest {
    ...
    public static final String SQL = "CREATE TABLE `t_link_%d` (\n" +
            ...
            "  `short_uri` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '短链接',\n" +
            ...
            "  `enable_status` tinyint(1) DEFAULT '0' COMMENT '是否启用标识 0:启用 1：未启用',\n" +
            "  `create_type` tinyint(1) DEFAULT NULL COMMENT '创建类型 0：接口创建 1：控制台创建',\n" +
            "  `valid_date_type` tinyint(1) DEFAULT NULL COMMENT '有效期类型 0：永久有效 1：自定义有效',\n" +
            ...
            "  `favicon` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '图标',\n" +
            "  PRIMARY KEY (`id`),\n" +
            "  UNIQUE KEY `idx_unique_full_short_url` (`full_short_url`) USING BTREE\n" +
            ") ENGINE=InnoDB AUTO_INCREMENT=1873650634385817602 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;";
